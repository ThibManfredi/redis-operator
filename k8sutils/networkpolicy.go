...
func generateNetworkPolicyDef(networkPolicyMeta metav1.ObjectMeta, config *v1beta1.NetworkPolicyConfig) *networkv1.NetworkPolicy {
...
func getNetworkPolicyIngressConfiguration(
	...
	config *v1beta1.NetworkPolicyConfig,
	...
	if config != nil {
		ingress = append(ingress, networkv1.NetworkPolicyIngressRule{
			From: []networkv1.NetworkPolicyPeer{
				{
					PodSelector: &metav1.LabelSelector{
...
func CreateOrUpdateNetworkPolicy(namespace string, networkPolicyMeta metav1.ObjectMeta, ownerDef metav1.OwnerReference, config *v1beta1.NetworkPolicyConfig) error {
